...
class MainWindow(QTabWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("images/UI/right.png"))
        # 图片读取进程
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/UI/right.png'))
        ...
        self.setTabIcon(0, QIcon('images/UI/right.png'))
        self.setTabIcon(1, QIcon('images/UI/right.png'))
